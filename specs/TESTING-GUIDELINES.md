...
- **Abstraction boundary** — every test interacts with peers only through the filesystem interface; no test bypasses it to manipulate files directly after setup
